            ...
            while (!userInput.equals("6")) {
                ...
                switch (userInput) {
                    ...
                    case "2":
                        ...
                        for(String city: TravelOptions.destinations().keySet() ){
                            System.out.println(city);
                        }
                        String city=scan1.next();
                        for(String city2: TravelOptions.destinations().keySet() ){
                            if(city2.equalsIgnoreCase(city)){
                                List<String> places= TravelOptions.destinations().get(city2);
                                ...
                                for(int i=0; i<places.size();i++){
                                    if(places.get(i).equalsIgnoreCase(place)){
                                        balance=FeeAndDiscount.fee.get(city2);
                                    }
                                }
                            }}
                    case "3":
                        System.out.println("3 - Here is our Price List for each city");
                        System.out.println(FeeAndDiscount.fee.toString());
                    case "4":
                        ...
                        for (int i = 0; i < subscribers.size(); i++) {
                            if (subscribers.get(i).equalsIgnoreCase(userName1)) {
                                ...
                                balance= FeeAndDiscount.discount(balance,50);
                            }
                        }
                    case "5":
